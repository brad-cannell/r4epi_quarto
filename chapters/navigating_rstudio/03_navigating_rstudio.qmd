...
```{r}
#| label: navigating_RStudio_interface_rstudio
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_interface_console
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_one-plus-one
#| echo: false 
...
```{r}
#| label: navigating_RStudio_interface_interface_seq-function
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_interface_environment-pane
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_environment-pane2 
#| echo: FALSE
...
Next, let’s talk about the Files/Plots/Packages/Help/Viewer pane (that’s a mouthful). \@ref(fig:files_pane) 

```{r}
#| label: navigating_RStudio_interface_files-pane
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_help
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_source1
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_source2
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_source3
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_preferences1
#| echo: false
...
```{r}
#| label: navigating_RStudio_interface_preferences3 
#| echo: false 
...
```{r}
#| label: navigating_RStudio_interface_preferences4 
#| echo: false 
