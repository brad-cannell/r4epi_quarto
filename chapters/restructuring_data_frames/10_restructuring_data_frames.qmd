...
knitr::include_graphics("/chapters/restructuring_data_frames/wide1.png")
```
...
knitr::include_graphics("/chapters/restructuring_data_frames/long1.png")
```
...
knitr::include_graphics("/chapters/restructuring_data_frames/wide2.png")
```
...
#| echo: false
#| fig-cap: Baby weights at 3, 6, 9, and 12 months. Babies 1001 and 1002 only.
knitr::include_graphics("/chapters/restructuring_data_frames/long2.png")
```
...
knitr::include_graphics("/chapters/restructuring_data_frames/wide_and_long.png")
```
...
knitr::include_graphics("/chapters/restructuring_data_frames/days_wide.png")
```
...
#| echo: false
#| fig-cap: Baby weights at age in days. Babies 1001 and 1002 only.
knitr::include_graphics("/chapters/restructuring_data_frames/days_long.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/restructuring_data_frames/names_to.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/restructuring_data_frames/values_to.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/restructuring_data_frames/names_sep1.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/restructuring_data_frames/names_sep2.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/restructuring_data_frames/value.png")
```
