# Using git and GitHub {#sec-using-git-and-github}
<!--
...
Arthur can continue adding files to his local repository and then pushing them to GitHub in this fashion for the remainder of the time he is working on this project, and the [introduction to git and GitHub chapter](../chapters/intro_git_github/intro_git_github.qmd) discusses _why_ he should consider doing so.
