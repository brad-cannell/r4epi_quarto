...
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/values.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/conditions.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/rain.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/operands.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/comparison-numeric.png")
```

```{r}
#| label: 14_conditional_operations_comparison-character_chunk
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/comparison-character.png")
```

```{r}
#| label: 15_conditional_operations_arithmetic_chunk
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/arithmetic.png")
```

```{r}
#| label: 16_conditional_operations_logical_chunk
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/logical.png")
```
...
#| echo: false
knitr::include_graphics("/chapters/conditional_operations/bp.png")
```
