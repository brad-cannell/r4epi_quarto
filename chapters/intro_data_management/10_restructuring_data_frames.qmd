...
```{r}
#| label: 801_intro_data_management_wide1_chunk
#| echo: false
#| fig-cap: Baby weights at 3, 6, 9, and 12 months.
knitr::include_graphics("/chapters/intro_data_management/wide1.png")
```
...
```{r}
#| label: 802_intro_data_management_long1_chunk
#| echo: false
#| fig-cap: Baby weights at 3, 6, 9, and 12 months. Babies 1001 and 1002 only.
knitr::include_graphics("/chapters/intro_data_management/long1.png")
```
...
```{r}
#| label: 803_intro_data_management_wide2_chunk
#| echo: false
#| fig-cap: Various measurements take at birth for 8 newborn babies.
knitr::include_graphics("/chapters/intro_data_management/wide2.png")
```
...
```{r}
#| label: 804_intro_data_management_wide1_chunk
#| echo: false
#| fig-cap: Baby weights at 3, 6, 9, and 12 months
knitr::include_graphics("/chapters/intro_data_management/wide1.png")
```
...
```{r}
#| label: 805_intro_data_management_long2_chunk
#| echo: false
#| fig-cap: Baby weights at 3, 6, 9, and 12 months. Babies 1001 and 1002 only.
knitr::include_graphics("/chapters/intro_data_management/long2.png")
```
...
```{r}
#| label: 806_intro_data_management_wide_and_long_chunk
#| echo: false
#| fig-cap: Comparing wide and long data for the babies 1001 and 1002.
knitr::include_graphics("/chapters/intro_data_management/wide_and_long.png")
```
...
```{r}
#| label: 807_intro_data_management_days_wide_chunk
#| echo: false
#| fig-cap: Baby weights at age in days. Babies 1001 and 1002 only.
knitr::include_graphics("/chapters/intro_data_management/days_wide.png")
```
...
```{r}
#| label: 808_intro_data_management_days_long_chunk
#| echo: false
#| fig-cap: Baby weights at age in days. Babies 1001 and 1002 only.
knitr::include_graphics("/chapters/intro_data_management/days_long.png")
```
...
```{r}
#| label: 809_intro_data_management_chunk
#| echo: false
#| message: false
#| warning: false
library(tidyr)
...
```{r}
#| label: 810_intro_data_management_wide1_chunk
#| echo: false
#| fig-cap: Baby weights at 3, 6, 9, and 12 months
knitr::include_graphics("/chapters/intro_data_management/wide1.png")
```
...
```{r}
#| label: 811_intro_data_management_chunk
#| echo: false
babies <- tibble(
  id       = 1001:1008,
...
```{r}
#| label: 812_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
...
```{r}
#| label: 813_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols = starts_with("weight")
...
```{r}
#| label: 814_intro_data_management_names_to_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/names_to.png")
```
...
```{r}
#| label: 815_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols     = starts_with("weight"),
...
```{r}
#| label: 816_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols         = starts_with("weight"),
...
```{r}
#| label: 817_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols         = starts_with("weight"),
...
```{r}
#| label: 818_intro_data_management_values_to_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/values_to.png")
```
...
```{r}
#| label: 819_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols         = starts_with("weight"),
...
```{r}
#| label: 820_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols         = starts_with("weight"),
...
```{r}
#| label: 821_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols            = starts_with("weight"),
...
```{r}
#| label: 822_intro_data_management_chunk
#| echo: false
set.seed(123)
babies <- tibble(
  id       = 1001:1008,
...
```{r}
#| label: 823_intro_data_management_chunk
#| echo: false
babies %>% 
  pivot_longer(
    cols      = c(-id, -sex),
...
```{r}
#| label: 824_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols         = starts_with("weight"),
...
```{r}
#| label: 825_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols         = c(-id, -sex),
...
```{r}
#| label: 826_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols         = c(-id, -sex),
...
```{r}
#| label: 827_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols      = c(-id, -sex),
...
```{r}
#| label: 828_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols     = c(-id, -sex),
...
```{r}
#| label: 829_intro_data_management_chunk
#| echo: false
#| error: true
babies_long <- babies %>% 
  pivot_longer(
...
```{r}
#| label: 830_intro_data_management_names_sep1_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/names_sep1.png")
```
...
```{r}
#| label: 831_intro_data_management_names_sep2_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/names_sep2.png")
```
...
```{r}
#| label: 832_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols      = c(-id, -sex),
...
```{r}
#| label: 833_intro_data_management_value_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/value.png")
```

Now, let's add the `.value` special value to our code:

```{r}
#| label: 834_intro_data_management_chunk
#| echo: false
babies_long <- babies %>% 
  pivot_longer(
    cols      = c(-id, -sex),
...
```{r}
#| label: 835_intro_data_management_chunk
#| echo: false
#| error: true
babies %>% 
  pivot_longer(
...
```{r}
#| label: 836_intro_data_management_chunk
#| echo: false
babies_long %>% 
...
```{r}
#| label: 837_intro_data_management_chunk
#| echo: false
babies_long
```
...
```{r}
#| label: 838_intro_data_management_chunk
#| echo: false
babies <- babies_long %>% 
  pivot_wider(
    names_from  = "months",
...
```{r}
#| label: 839_intro_data_management_chunk
#| echo: false
df <- tribble(
...
```{r}
#| label: 840_intro_data_management_chunk
#| echo: false
df %>% pivot_wider(
  names_from  = "measure",
...
```{r}
#| label: 841_intro_data_management_chunk
#| echo: false
babies %>% 
  count(sex)
```
...
```{r}
#| label: 842_intro_data_management_chunk
#| echo: false
mean_weights <- babies %>% 
  summarise(
    mean(weight_3),
...
```{r}
#| label: 843_intro_data_management_chunk
#| echo: false
mean_weights %>% 
  pivot_longer(
    cols = everything(),
...
```{r}
#| label: 844_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 845_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 846_intro_data_management_chunk
#| echo: false
summary_stats %>% 
...
```{r}
#| label: 847_intro_data_management_chunk
#| echo: false
births_ntd <- tibble(
...
```{r}
#| label: 848_intro_data_management_chunk
#| echo: false
births_ntd %>% 
  pivot_wider(
    names_from  = "outcome",
...
```{r}
#| label: 849_intro_data_management_chunk
#| echo: false
births_sex <- tibble(
  state  = c("CA", "FL", "TX"),
...
```{r}
#| label: 850_intro_data_management_chunk
#| echo: false
births_sex %>% 
  pivot_longer(
    cols      = -state,
...
```{r}
#| label: 851_intro_data_management_chunk
#| echo: false
babies
```
...
```{r}
#| label: 852_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 853_intro_data_management_chunk
#| echo: false
births_decade %>% 
  pivot_longer(
    cols      = -state,
...
```{r}
#| label: 854_intro_data_management_chunk
#| echo: false
baby_sleep <- tibble(
  id          = c(1001, 1002, 1003),
...
```{r}
#| label: 855_intro_data_management_chunk
#| echo: false
baby_sleep %>% 
  separate(
    col     = sleep_range,
...
```{r}
#| label: 856_intro_data_management_chunk
#| echo: false
reports <- tibble(
  date      = as.Date(c(
...
```{r}
#| label: 857_intro_data_management_chunk
#| echo: false
reports %>% 
  count(date)
```
...
```{r}
#| label: 858_intro_data_management_chunk
#| echo: false
reports %>% 
  count(date) %>% 
...
```{r}
#| label: 859_intro_data_management_chunk
#| echo: false
reports %>% 
  count(date) %>% 
  complete(
...
```{r}
#| label: 860_intro_data_management_chunk
#| echo: false
reports %>% 
  count(date) %>% 
  complete(
...
```{r}
#| label: 861_intro_data_management_chunk
#| echo: false
reports %>% 
  count(date) %>% 
  complete(
