...
```{r}
#| label: 701_intro_data_management_agencies_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/agencies.png")
```

Additionally, large studies often gather data at multiple sites.

```{r}
#| label: 702_intro_data_management_sites_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/sites.png")
```
...
```{r}
#| label: 703_intro_data_management_time_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/time.png")
```
...
```{r}
#| label: 704_intro_data_management_instruments_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/instruments.png")
```

In any of these cases, you may need to combine data from across data sets in order to complete your analysis. 

```{r}
#| label: 705_intro_data_management_datasets_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/datasets.png")
```
...
```{r}
#| label: 706_intro_data_management_two_data_sets1_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/two_data_sets1.png")
```
...
```{r}
#| label: 707_intro_data_management_two_data_sets2_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/two_data_sets2.png")
```
...
```{r}
#| label: 708_intro_data_management_trial_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/trial.png")
```
...
```{r}
#| label: 709_intro_data_management_chunk
#| echo: false
#| message: false
library(dplyr)
```
...
```{r}
#| label: 710_intro_data_management_chunk
#| echo: false
trial <- tibble(
...
```{r}
#| label: 711_intro_data_management_chunk
#| echo: false
trial_2020 <- tibble(
  year    = 2020,
  n       = 500,
...
```{r}
#| label: 712_intro_data_management_chunk
#| echo: false
trial %>% 
...
```{r}
#| label: 713_intro_data_management_chunk
#| echo: false
trial_2021 <- tibble(
  year      = 2021,
  n         = 598,
...
```{r}
#| label: 714_intro_data_management_chunk
#| echo: false
trial %>% 
...
```{r}
#| label: 715_intro_data_management_chunk
#| echo: false
trial_2020 <- tibble(
  year      = 2020,
  n         = 500,
...
```{r}
#| label: 716_intro_data_management_chunk
#| echo: false
trial %>% 
  bind_rows(trial_2020)
```
...
```{r}
#| label: 717_intro_data_management_chunk
#| echo: false
trial_2020 <- tibble(
  year      = 2020,
  n         = 500,
...
```{r}
#| label: 718_intro_data_management_chunk
#| echo: false
trial %>% 
  bind_rows(trial_2020)
```
...
```{r}
#| label: 719_intro_data_management_chunk
#| echo: false
trial_2020 <- tibble(
  year      = 2020,
  count     = 500,
...
```{r}
#| label: 720_intro_data_management_chunk
#| echo: false
trial %>% 
  bind_rows(trial_2020)
```
...
```{r}
#| label: 721_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 722_intro_data_management_chunk
#| echo: false
trial %>% 
  bind_rows(
    trial_2020 %>% 
...
```{r}
#| label: 723_intro_data_management_two_data_sets_horiz_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/two_data_sets_horiz.png")
```
...
```{r}
#| label: 724_intro_data_management_goal_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/goal.png")
```
...
```{r}
#| label: 725_intro_data_management_flow_chart_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/flow_chart.png")
```
...
```{r}
#| label: 726_intro_data_management_position_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/position.png")
```
...
```{r}
#| label: 727_intro_data_management_chunk
#| echo: false
df1 <- tibble(
...
```{r}
#| label: 728_intro_data_management_chunk
#| echo: false
df2 <- tibble(
  amount = c(1, 4, 3),
  dose   = c(10, 20, 30)
...
```{r}
#| label: 729_intro_data_management_chunk
#| echo: false
df1 %>% 
  bind_cols(df2)
```
...
```{r}
#| label: 730_intro_data_management_flow_chart_key_value_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/flow_chart_key_value.png")
```
...
```{r}
#| label: 731_intro_data_management_one_to_one_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/one_to_one.png")
```
...
```{r}
#| label: 732_intro_data_management_one_to_many_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/one_to_many.png")
```
...
```{r}
#| label: 733_intro_data_management_many_to_many_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/many_to_many.png")
```
...
```{r}
#| label: 734_intro_data_management_left_join_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/left_join.png")
```
...
```{r}
#| label: 735_intro_data_management_right_join_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/right_join.png")
```
...
```{r}
#| label: 736_intro_data_management_full_join_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/full_join.png")
```
...
```{r}
#| label: 737_intro_data_management_inner_join_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/inner_join.png")
```
...
```{r}
#| label: 738_intro_data_management_chunk
#| echo: false
demographics <- tibble(
...
```{r}
#| label: 739_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 740_intro_data_management_chunk
#| echo: false
demographics %>% 
...
```{r}
#| label: 741_intro_data_management_chunk
#| echo: false
demographics %>% 
...
```{r}
#| label: 742_intro_data_management_chunk
#| echo: false
# Right join
demographics %>% 
...
```{r}
#| label: 743_intro_data_management_chunk
#| echo: false
# Full join
demographics %>% 
...
```{r}
#| label: 744_intro_data_management_chunk
#| echo: false
# Inner join
demographics %>% 
...
```{r}
#| label: 745_intro_data_management_chunk
#| echo: false
# Switching order
grip_strength %>% 
...
```{r}
#| label: 746_intro_data_management_chunk
#| echo: false
demographics <- tibble(
...
```{r}
#| label: 747_intro_data_management_chunk
#| echo: false
demographics %>% 
  left_join(grip_strength, by = "id")
```
...
```{r}
#| label: 748_intro_data_management_chunk
#| echo: false
# Right join
demographics %>% 
  right_join(grip_strength, by = "id")
...
```{r}
#| label: 749_intro_data_management_chunk
#| echo: false
# Full join
demographics %>% 
  full_join(grip_strength, by = "id")
...
```{r}
#| label: 750_intro_data_management_chunk
#| echo: false
# Inner join
demographics %>% 
  inner_join(grip_strength, by = "id")
...
```{r}
#| label: 751_intro_data_management_chunk
#| echo: false
# Switching order
grip_strength %>% 
  left_join(demographics, by = "id")
...
```{r}
#| label: 752_intro_data_management_chunk
#| echo: false
grip_strength <- tibble(
...
```{r}
#| label: 753_intro_data_management_chunk
#| echo: false
#| error: true
demographics %>% 
  left_join(grip_strength, by = "id")
...
```{r}
#| label: 754_intro_data_management_chunk
#| echo: false
demographics %>% 
...
```{r}
#| label: 755_intro_data_management_chunk
#| echo: false
demographics
```
...
```{r}
#| label: 756_intro_data_management_chunk
#| echo: false
grip_strength <- tibble(
...
```{r}
#| label: 757_intro_data_management_chunk
#| echo: false
demographics %>% 
  left_join(grip_strength, by = "id")
```
...
```{r}
#| label: 758_intro_data_management_chunk
#| echo: false
emr <- tibble(
  id     = rep(c("1001", "1002", "1003", "1004"), each = 2),
  visit  = rep(c("pre", "post"), 4),
...
```{r}
#| label: 759_intro_data_management_chunk
#| echo: false
demographics %>% 
...
```{r}
#| label: 760_intro_data_management_chunk
#| echo: false
demographics %>% 
  left_join(grip_strength, by = "id") %>% 
  left_join(emr, by = "id")
...
```{r}
#| label: 761_intro_data_management_many_to_many_emr_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/many_to_many_emr.png")
```
...
```{r}
#| label: 762_intro_data_management_one_to_one_emr_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/one_to_one_emr.png")
```

Here is how we tell `left_join()` to merge our data frames by `id` _and_ `visit`:

```{r}
#| label: 763_intro_data_management_chunk
#| echo: false
demographics %>% 
  left_join(grip_strength, by = "id") %>% 
