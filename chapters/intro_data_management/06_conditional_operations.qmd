...
```{r}
#| label: 601_intro_data_management_values_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/values.png")
```
...
```{r}
#| label: 602_intro_data_management_conditions_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/conditions.png")
```
...
```{r}
#| label: 603_intro_data_management_rain_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/rain.png")
```
...
```{r}
#| label: 604_intro_data_management_chunk
#| echo: false
#| message: false
library(dplyr)
```
...
```{r}
#| label: 605_intro_data_management_chunk
#| echo: false
rainy_days <- tibble(
  day     = 1:5,
...
```{r}
#| label: 606_intro_data_management_chunk
#| echo: false
rainy_days %>% 
  mutate(
    raincoat = if_else(
...
```{r}
#| label: 607_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 608_intro_data_management_chunk
#| echo: false
rainy_days %>% 
  mutate(
...
```{r}
#| label: 609_intro_data_management_chunk
#| echo: false
rainy_days %>% 
  mutate(
...
```{r}
#| label: 610_intro_data_management_chunk
#| echo: false
rainy_days %>% 
  mutate(
...
```{r}
#| label: 611_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 612_intro_data_management_operands_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/operands.png")
```
...
```{r}
#| label: 613_intro_data_management_comparison-numeric_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/comparison-numeric.png")
```

```{r}
#| label: 614_intro_data_management_comparison-character_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/comparison-character.png")
```

```{r}
#| label: 615_intro_data_management_arithmetic_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/arithmetic.png")
```

```{r}
#| label: 616_intro_data_management_logical_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/logical.png")
```
...
```{r}
#| label: 617_intro_data_management_chunk
#| echo: false
df <- tibble(
  id        = c(1, 1, 2, 2),
  outcome   = c(0, 1, 1, 1)
...
```{r}
#| label: 618_intro_data_management_chunk
#| echo: false
df %>% 
  mutate(
...
```{r}
#| label: 619_intro_data_management_chunk
#| echo: false
df <- tibble(
  name1 = c("Jon", "John", NA),
  name2 = c("Jon", "Jon", "Jon")
...
```{r}
#| label: 620_intro_data_management_chunk
#| echo: false
df %>% 
  mutate(
...
```{r}
#| label: 621_intro_data_management_chunk
#| echo: false
df %>% 
  mutate(
    name_match = name1 == name2,
...
```{r}
#| label: 622_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 623_intro_data_management_chunk
#| echo: false
blood_pressure %>% 
...
```{r}
#| label: 624_intro_data_management_bp_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/bp.png")
```

This is the perfect opportunity to use `dplyr`'s `case_when()` function. Take a look:

```{r}
#| label: 625_intro_data_management_chunk
#| echo: false
blood_pressure %>% 
  mutate(
    bp = case_when(
...
```{r}
#| label: 626_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 627_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    age_3cat = case_when(
...
```{r}
#| label: 628_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    age_3cat = case_when(
...
```{r}
#| label: 629_intro_data_management_chunk
#| echo: false
#| error: true
ages %>% 
  mutate(
...
```{r}
#| label: 630_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    age_3cat = case_when(
...
```{r}
#| label: 631_intro_data_management_chunk
#| echo: false
df <- tibble(
  number = c(1, 2, 3)
) %>% 
...
```{r}
#| label: 632_intro_data_management_chunk
#| echo: false
df %>% 
  mutate(
    size = case_when(
...
```{r}
#| label: 633_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    age_3cat = case_when(
...
```{r}
#| label: 634_intro_data_management_chunk
#| echo: false
demographics <- ages %>% 
  mutate(
...
```{r}
#| label: 635_intro_data_management_chunk
#| echo: false
#| error: true
demographics %>% 
  mutate(
...
```{r}
#| label: 636_intro_data_management_chunk
#| echo: false
#| error: true
demographics %>% 
  mutate(
...
```{r}
#| label: 637_intro_data_management_chunk
#| echo: false
#| error: true
demographics %>% 
  mutate(
...
```{r}
#| label: 638_intro_data_management_chunk
#| echo: false
demographics %>% 
  mutate(
    race_eth_4cat = case_when(
...
```{r}
#| label: 639_intro_data_management_chunk
#| echo: false
demographics %>% 
  # Recode variables
  mutate(
