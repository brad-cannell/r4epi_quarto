...
```{r}
#| label: 301_intro_data_management_rows_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/rows.png")
```
...
```{r}
#| label: 302_intro_data_management_columns_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/columns.png")
```
...
```{r}
#| label: 303_intro_data_management_chunk
#| echo: false
#| message: false
# Load dplyr
library(dplyr)
...
```{r}
#| label: 304_intro_data_management_chunk
#| echo: false
set.seed(123)
...
```{r}
#| label: 305_intro_data_management_chunk
#| echo: false
drug_trial
```
...
```{r}
#| label: 306_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 307_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 308_intro_data_management_chunk
#| echo: false
drug_trial <- drug_trial %>% 
...
```{r}
#| label: 309_intro_data_management_chunk
#| echo: false
drug_trial <- drug_trial %>% 
...
```{r}
#| label: 310_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 311_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 312_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 313_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 314_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 315_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  select(1:2, 4)
```
...
```{r}
#| label: 316_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 317_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  select(-n_se_year)
```
...
```{r}
#| label: 318_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  select(!n_se_year)
```
...
```{r}
#| label: 319_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
...
```{r}
#| label: 320_intro_data_management_chunk
#| echo: false
nhanes <- tibble(
  SEQN = c(1:4),
  ALQ101 = c(1, 2, 1, 2),
...
```{r}
#| label: 321_intro_data_management_chunk
#| echo: false
nhanes %>% 
  rename(
    id = SEQN,
...
```{r}
#| label: 322_intro_data_management_chunk
#| echo: false
nhanes %>% 
  rename_with(tolower)
```
...
```{r}
#| label: 323_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  select(1:2, 4)
```
...
```{r}
#| label: 324_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  slice(1:5)
```
...
```{r}
#| label: 325_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  filter(year == 0)
```
...
```{r}
#| label: 326_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial %>% 
  filter(year == 0) %>% 
...
```{r}
#| label: 327_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial %>% 
  filter(year == 0) %>% 
...
```{r}
#| label: 328_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial %>% 
  filter(year == 0) %>% 
...
```{r}
#| label: 329_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial %>% 
...
```{r}
#| label: 330_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 331_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial_short %>% 
  group_by(drug) %>% 
...
```{r}
#| label: 332_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial_short %>% 
  group_by(drug) %>% 
...
```{r}
#| label: 333_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial_short %>% 
  filter(!is.na(age)) %>% 
...
```{r}
#| label: 334_intro_data_management_chunk
#| echo: false
#| message: false
drug_trial_short %>% 
...
```{r}
#| label: 335_intro_data_management_chunk
#| echo: false
#| rows-print: 12
df <- tribble(
  ~id, ~day, ~x,
...
```{r}
#| label: 336_intro_data_management_chunk
#| echo: false
#| rows-print: 12
df %>% 
  distinct()
...
```{r}
#| label: 337_intro_data_management_chunk
#| echo: false
#| rows-print: 12
df %>% 
...
```{r}
#| label: 338_intro_data_management_chunk
#| echo: false
df %>% 
  group_by_all() %>% 
  mutate(
...
```{r}
#| label: 339_intro_data_management_chunk
#| echo: false
df %>% 
...
```{r}
#| label: 340_intro_data_management_chunk
#| echo: false
df %>% 
...
```{r}
#| label: 341_intro_data_management_chunk
#| echo: false
#| rows-print: 12
df %>% 
  group_by(id, day) %>% 
...
```{r}
#| label: 342_intro_data_management_chunk
#| echo: false
#| message: false
df %>% 
  group_by(id, day) %>% 
