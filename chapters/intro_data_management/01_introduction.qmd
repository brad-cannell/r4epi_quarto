...
```{r}
#| label: 101_intro_data_management_chunk
#| echo: false
# No problem
df <- tibble(
  id = c(1, 2, 3),
...
```{r}
#| label: 102_intro_data_management_chunk
#| echo: false
#| error: true
# Problem
l <- list(
...
```{r}
#| label: 103_intro_data_management_chunk
#| echo: false
df %>% 
  filter(x == 0)
```
...
```{r}
#| label: 104_intro_data_management_chunk
#| echo: false
df %>% 
  filter(df$x == 0)
```
...
```{r}
#| label: 105_intro_data_management_chunk
#| echo: false
df %>% 
  filter(x == 0)
```
