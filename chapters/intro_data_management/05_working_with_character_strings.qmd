...
```{r}
#| label: 501_intro_data_management_chunk
#| echo: false
#| message: false
library(readr)
library(dplyr)
...
```{r}
#| label: 502_intro_data_management_chunk
#| echo: false
#| cache: true
...
```{r}
#| label: 503_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr 
```
...
```{r}
#| label: 504_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
  group_by(name) %>% 
...
```{r}
#| label: 505_intro_data_management_chunk
#| echo: false
ehr %>% 
  arrange(name) %>% 
  pull(name)
...
```{r}
#| label: 506_intro_data_management_chunk
#| echo: false
ehr %>% 
  arrange(name) %>% 
  pull(name) %>% 
...
```{r}
#| label: 507_intro_data_management_chunk
#| echo: false
ehr %>% 
  arrange(name) %>% 
  pull(name) %>% 
...
```{r}
#| label: 508_intro_data_management_chunk
#| echo: false
ehr %>% 
  arrange(name) %>% 
  pull(name) %>% 
...
```{r}
#| label: 509_intro_data_management_chunk
#| echo: false
ehr %>% 
  arrange(name) %>% 
  pull(name) %>% 
...
```{r}
#| label: 510_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr <- ehr %>% 
...
```{r}
#| label: 511_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
  group_by(name) %>% 
...
```{r}
#| label: 512_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 513_intro_data_management_chunk
#| echo: false
ehr <- ehr %>% 
...
```{r}
#| label: 514_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
  group_by(name) %>% 
...
```{r}
#| label: 515_intro_data_management_chunk
#| echo: false
str_replace(
  string      = "weston fox,", 
  pattern     = ",",
...
```{r}
#| label: 516_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr <- ehr %>% 
...
```{r}
#| label: 517_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
  group_by(name) %>% 
...
```{r}
#| label: 518_intro_data_management_chunk
#| echo: false
str_replace(
...
```{r}
#| label: 519_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr <- ehr %>% 
...
```{r}
#| label: 520_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
  group_by(name) %>% 
...
```{r}
#| label: 521_intro_data_management_chunk
#| echo: false
str_replace(
  string      = "Ivy   Mccann",
  pattern     = "\\s{2,}",
...
```{r}
#| label: 522_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr <- ehr %>% 
...
```{r}
#| label: 523_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
  group_by(name) %>% 
...
```{r}
#| label: 524_intro_data_management_chunk
#| echo: false
ehr %>% 
  group_by(name) %>% 
  filter(row_number() == 1) %>% 
...
```{r}
#| label: 525_intro_data_management_chunk
#| echo: false
ehr_unique <- ehr %>% 
  group_by(name) %>% 
  filter(row_number() == 1) %>% 
...
```{r}
#| label: 526_intro_data_management_chunk
#| echo: false
#| message: false
ehr %>% 
  group_by(city) %>% 
...
```{r}
#| label: 527_intro_data_management_chunk
#| echo: false
ehr <- ehr %>% 
  mutate(
...
```{r}
#| label: 528_intro_data_management_chunk
#| echo: false
#| message: false
ehr %>% 
  group_by(city) %>% 
...
```{r}
#| label: 529_intro_data_management_chunk
#| echo: false
str_replace(
...
```{r}
#| label: 530_intro_data_management_chunk
#| echo: false
ehr <- ehr %>% 
...
```{r}
#| label: 531_intro_data_management_chunk
#| echo: false
#| message: false
ehr %>% 
  group_by(city) %>% 
...
```{r}
#| label: 532_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 533_intro_data_management_chunk
#| echo: false
str_extract("zariah hernandez", "\\w+$")
```
...
```{r}
#| label: 534_intro_data_management_chunk
#| echo: false
ehr <- ehr %>% 
  mutate(
...
```{r}
#| label: 535_intro_data_management_chunk
#| echo: false
ehr %>% 
...
```{r}
#| label: 536_intro_data_management_regex101_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/regex101.png")
```
...
```{r}
#| label: 537_intro_data_management_chunk
#| echo: false
#| rows-print: 15
ehr %>% 
...
```{r}
#| label: 538_intro_data_management_chunk
#| echo: false
#| message: false
ehr %>% 
  group_by(symptoms) %>% 
...
```{r}
#| label: 539_intro_data_management_chunk
#| echo: false
ehr <- ehr %>% 
  mutate(
...
```{r}
#| label: 540_intro_data_management_chunk
#| echo: false
ehr %>% 
...
```{r}
#| label: 541_intro_data_management_chunk
#| echo: false
table(ehr$headache)
```
...
```{r}
#| label: 542_intro_data_management_chunk
#| echo: false
ehr %>% 
  select(pain) %>% 
