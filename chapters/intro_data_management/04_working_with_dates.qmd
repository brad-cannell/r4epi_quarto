...
```{r}
#| label: 401_intro_data_management_chunk
#| echo: false
#| message: false
library(dplyr)
```
...
```{r}
#| label: 402_intro_data_management_chunk
#| echo: false
birth_dates <- readr::read_csv("data/birth_dates.csv")
```

```{r}
#| label: 403_intro_data_management_chunk
#| echo: false
birth_dates
```
...
```{r}
#| label: 404_intro_data_management_timeline_chunk
#| echo: false
knitr::include_graphics("/chapters/intro_data_management/timeline.png")
```

For example, let's use base R's `as.Date()` function to create a date value from the string "2000-01-01".

```{r}
#| label: 405_intro_data_management_chunk
#| echo: false
as.Date("2000-01-01")
```
...
```{r}
#| label: 406_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 407_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 408_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 409_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 410_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 411_intro_data_management_chunk
#| echo: false
from_sas <- tibble(
...
```{r}
#| label: 412_intro_data_management_chunk
#| echo: false
from_sas %>% 
...
```{r}
#| label: 413_intro_data_management_chunk
#| echo: false
birth_dates %>% 
...
```{r}
#| label: 414_intro_data_management_chunk
#| echo: false
tribble(
...
```{r}
#| label: 415_intro_data_management_chunk
#| echo: false
birth_dates
```
...
```{r}
#| label: 416_intro_data_management_chunk
#| echo: false
birth_dates %>% 
...
```{r}
#| label: 417_intro_data_management_chunk
#| echo: false
birth_dates %>% 
...
```{r}
#| label: 418_intro_data_management_chunk
#| echo: false
birth_dates %>% 
  mutate(dob_typical_to_date = as.Date(dob_typical, format = "%m/%d/%Y")) %>% 
  select(dob_typical, dob_typical_to_date)
...
```{r}
#| label: 419_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 420_intro_data_management_chunk
#| echo: false
birth_dates %>% 
...
```{r}
#| label: 421_intro_data_management_chunk
#| echo: false
birth_dates %>% 
...
```{r}
#| label: 422_intro_data_management_chunk
#| echo: false
Sys.Date()
```

```{r}
#| label: 423_intro_data_management_chunk
#| echo: false
lubridate::today()
```
...
```{r}
#| label: 424_intro_data_management_chunk
#| echo: false
Sys.time()
```

```{r}
#| label: 425_intro_data_management_chunk
#| echo: false
lubridate::now()
```
...
```{r}
#| label: 426_intro_data_management_chunk
#| echo: false
set.seed(703)
...
```{r}
#| label: 427_intro_data_management_chunk
#| echo: false
# Save the start time
start  <- lubridate::now()
sum    <- sum(rand_mill)
...
```{r}
#| label: 428_intro_data_management_chunk
#| echo: false
stop - start
```

```{r}
#| label: 429_intro_data_management_chunk
#| echo: false
rm(mean)
```
...
```{r}
#| label: 430_intro_data_management_chunk
#| echo: false
# Save the start time
start  <- lubridate::now()
mean(rand_mill)
...
```{r}
#| label: 431_intro_data_management_chunk
#| echo: false
stop - start
```
...
```{r}
#| label: 432_intro_data_management_chunk
#| echo: false
month.name
```
...
```{r}
#| label: 433_intro_data_management_chunk
#| echo: false
month.abb
```
...
```{r}
#| label: 434_intro_data_management_chunk
#| echo: false
seq.Date(
...
```{r}
#| label: 435_intro_data_management_chunk
#| echo: false
ages <- birth_dates %>% 
...
```{r}
#| label: 436_intro_data_management_chunk
#| echo: false
#| eval: false
ages %>% 
...
```{r}
#| label: 437_intro_data_management_chunk
#| echo: false
ages <- ages %>% 
...
```{r}
#| label: 438_intro_data_management_chunk
#| echo: false
#| message: false
library(lubridate)
```
...
```{r}
#| label: 439_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
...
```{r}
#| label: 440_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
...
```{r}
#| label: 441_intro_data_management_chunk
#| echo: false
years(1)
```
...
```{r}
#| label: 442_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 443_intro_data_management_chunk
#| echo: false
# The base R way
...
```{r}
#| label: 444_intro_data_management_chunk
#| echo: false
# The lubridate way
(start %--% end) / years(1)
```
...
```{r}
#| label: 445_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 446_intro_data_management_chunk
#| echo: false
# The base R way
as.numeric(difftime(end, start)) / 365.25
```
...
```{r}
#| label: 447_intro_data_management_chunk
#| echo: false
# The lubridate way
(start %--% end) / years(1)
```
...
```{r}
#| label: 448_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
...
```{r}
#| label: 449_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    # If you want the age (in years) as of the person's last birthday
...
```{r}
#| label: 450_intro_data_management_chunk
#| echo: false
ages <- ages %>% 
  select(-today) %>% 
  print()
...
```{r}
#| label: 451_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    day   = day(dob),
...
```{r}
#| label: 452_intro_data_management_chunk
#| echo: false
ages %>% 
  mutate(
    wday         = wday(dob),
...
```{r}
#| label: 453_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 454_intro_data_management_chunk
#| echo: false
