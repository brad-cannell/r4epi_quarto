...
```{r}
#| label: 201_intro_data_management_chunk
#| echo: false
class <- tibble(
...
```{r}
#| label: 202_intro_data_management_chunk
#| echo: false
class$heights
```
...
```{r}
#| label: 203_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 204_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 205_intro_data_management_chunk
#| echo: false
class$heights[3]
```
...
```{r}
#| label: 206_intro_data_management_chunk
#| echo: false
class[["heights"]]
```
...
```{r}
#| label: 207_intro_data_management_chunk
#| echo: false
class[["heights"]] <- class[["heights"]] * 12
class
```
...
```{r}
#| label: 208_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 209_intro_data_management_chunk
#| echo: false
class["heights"]
```
...
```{r}
#| label: 210_intro_data_management_chunk
#| echo: false
class$heights[3]
```
...
```{r}
#| label: 211_intro_data_management_chunk
#| echo: false
class[["heights"]][3]
```
...
```{r}
#| label: 212_intro_data_management_chunk
#| echo: false
study_data <- tibble(
  id = c(1, 2, 3, 4),
  site = c("TX", "CA", "tx", "CA")
...
```{r}
#| label: 213_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 214_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 215_intro_data_management_chunk
#| echo: false
set.seed(123)
...
```{r}
#| label: 216_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 217_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 218_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 219_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 220_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 221_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  mutate(complete = c(
...
```{r}
#| label: 222_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  mutate(complete = 0)
```
...
```{r}
#| label: 223_intro_data_management_chunk
#| echo: false
#| error: true
drug_trial %>% 
...
```{r}
#| label: 224_intro_data_management_chunk
#| echo: false
#| error: true
...
```{r}
#| label: 225_intro_data_management_chunk
#| echo: false
class(drug_trial)
```
...
```{r}
#| label: 226_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 227_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 228_intro_data_management_chunk
#| echo: false
#| error: true
...
```{r}
#| label: 229_intro_data_management_chunk
#| echo: false
nums <- 1:10
nums
```
...
```{r}
#| label: 230_intro_data_management_chunk
#| echo: false
nums + 1
```
...
```{r}
#| label: 231_intro_data_management_chunk
#| echo: false
nums + c(1, 2)
```
...
```{r}
#| label: 232_intro_data_management_chunk
#| echo: false
nums + c(1, 2, 3)
```
...
```{r}
#| label: 233_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  mutate(complete = 0)
```
...
```{r}
#| label: 234_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 235_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 236_intro_data_management_chunk
#| echo: false
drug_trial %>% 
...
```{r}
#| label: 237_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  mutate(
...
```{r}
#| label: 238_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 239_intro_data_management_chunk
#| echo: false
drug_trial %>% 
  rowwise() %>% 
...
```{r}
#| label: 240_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 241_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
...
```{r}
#| label: 242_intro_data_management_chunk
#| echo: false
sum(c(0, 1, 0))
```

```{r}
#| label: 243_intro_data_management_chunk
#| echo: false
sum(c(1, 1, 0))
```

```{r}
#| label: 244_intro_data_management_chunk
#| echo: false
sum(
  c(0, 1, 0),
  c(1, 1, 0)
...
```{r}
#| label: 245_intro_data_management_chunk
#| echo: false
sum(drug_trial_sub$se_headache)
```

```{r}
#| label: 246_intro_data_management_chunk
#| echo: false
sum(drug_trial_sub$se_diarrhea)
```

```{r}
#| label: 247_intro_data_management_chunk
#| echo: false
sum(drug_trial_sub$se_dry_mouth)
```

```{r}
#| label: 248_intro_data_management_chunk
#| echo: false
sum(
...
```{r}
#| label: 249_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(any_se_year = sum(se_headache, se_diarrhea, se_dry_mouth))
...
```{r}
#| label: 250_intro_data_management_chunk
#| echo: false
# Is 0 greater than 0?
0 > 0
```
...
```{r}
#| label: 251_intro_data_management_chunk
#| echo: false
# Is 2 greater than 0?
2 > 0
```
...
```{r}
#| label: 252_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(
...
```{r}
#| label: 253_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(any_se_year = sum(se_headache, se_diarrhea, se_dry_mouth) > 0)
...
```{r}
#| label: 254_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(
...
```{r}
#| label: 255_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(
...
```{r}
#| label: 256_intro_data_management_chunk
#| echo: false
#| error: true
drug_trial_sub %>% 
  mutate(
...
```{r}
#| label: 257_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(
...
```{r}
#| label: 258_intro_data_management_chunk
#| echo: false
drug_trial_sub %>% 
  rowwise() %>% 
  mutate(
...
```{r}
#| label: 259_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 260_intro_data_management_chunk
#| echo: false
...
```{r}
#| label: 261_intro_data_management_chunk
#| echo: false
