...
- As I was doing that, I decided that I didn't want to just make the work repository below bold. I want to hyperlink it to the glossary. See emphasizing text in the [wiki](https://github.com/brad-cannell/r4epi_quarto/wiki/Emphasizing-Text). So, I started trying to figure out how to do that in the Test Quarto book. Once you do, come back and finish this.
